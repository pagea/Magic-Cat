...
void interject() {
    printf ("I\'d just like to interject for a moment. What you\'re refering to"
   " as Linux, is in fact, GNU/Linux, or as I\'ve recently taken to calling it,"
   ...
   " GNU system every day, without realizing it. Through a peculiar turn of"
   ...
   " with Linux added, or GNU/Linux. All the so-called \"Linux\" distributions"
